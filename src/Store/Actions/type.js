...
export const GET_CONTENT_FILTER_ITEM = 'GET_CONTENT_FILTER_ITEM';
...
export const GET_CONTENT_AUDIO = 'GET_CONTENT_AUDIO';
export const GET_WORDS_INFO = 'GET_WORDS_INFO';
